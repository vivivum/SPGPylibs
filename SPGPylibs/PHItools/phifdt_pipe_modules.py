...
def generate_level2(data,wave_axis,rte_mode,cmilos = 'pymilos',options = None,loopthis = 0):
    ...
    return phi_rte(data,wave_axis,rte_mode,cmilos = cmilos,options = options,loopthis=loopthis)
